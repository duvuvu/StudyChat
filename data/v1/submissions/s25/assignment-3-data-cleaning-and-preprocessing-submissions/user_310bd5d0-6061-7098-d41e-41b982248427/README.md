...
# How I set up this project
 ...
 - From within project terminal, run `uv init`, then `uv add --dev ipykernel`
 - Open the .ipynb file in VS Code, select "Change Kernel" at the top right, and select `.venv/bin/python`