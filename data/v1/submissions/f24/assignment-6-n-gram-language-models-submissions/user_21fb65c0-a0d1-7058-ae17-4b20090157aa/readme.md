...
makes a list of n frequency table through a loop after getting the length of the document and returns the array
...
P(x_{t+1} | x_1, x_2, \ldots, x_t) = \frac{f(x_1, x_2, \ldots, x_t, x_{t+1})}{f(x_1, x_2, \ldots, x_t)}


### Code analysis

- ***Put the intuition of your code here***
uses the frequency tables to look at a sequence and individually looks at unigrams in certain cases
...
1. $P(X_1=a, X_2=a, X_3=a)$
   - *Show your work*
p(a,a,a) = p(a| a,a) * p(a) * p(a|a) = (11/20)(5/11)(1/5) = .05

2. $P(X_1=a, X_2=a, X_3=b)$
   - *Show your work*
p(a, a, b) = p(b | a, a) * p(a) * p(a|a) = (5/11)(1/5)(2/5) = .03
3. $P(X_1=a, X_2=a, X_3=c)$
   - *Show your work* 
p(a,a,c) = p(c| a, a) * p(a) * p(a | a) = (11/20)(2/5)(1/5) = .044
...
- ***Put the intuition of your code here***
looks through the probalilities and picks the most probable one
...
- **Based on the probability distribution obtained above for all the next possible characters, which character would be next in the sequence?**
  - *Your answer*
 a since it has the highest probalilty
## Experiment
