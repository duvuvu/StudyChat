...
- ***The create_frequency_tables function constructs frequency tables for n-gram model and the tables contain the occurences or each n-gram in the input data. Before extracting n-grams, we need to normalize the text in the input file. This step is to remove the non-alphabetic characters and change the text into lowercase. After normalization, we can extract the ngrams. For each n-gram, we calculate how many times it occurs in the text.***
...
1. ***What is your vocabulary in this case***
   - [{('a',): 11, ('b',): 4, ('c',): 5}, {('a', 'a'): 5, ('a', 'b'): 3, ('b', 'a'): 2, ('b', 'c'): 2, ('c', 'a'): 3, ('a', 'c'): 2, ('c', 'c'): 1, ('c', 'b'): 1}, {('a', 'a', 'b'): 2, ('a', 'b', 'a'): 1, ('b', 'a', 'b'): 1, ('a', 'b', 'c'): 2, ('b', 'c', 'a'): 2, ('c', 'a', 'c'): 1, ('a', 'c', 'c'): 1, ('c', 'c', 'a'): 1, ('c', 'a', 'a'): 2, ('a', 'a', 'a'): 1, ('a', 'a', 'c'): 1, ('a', 'c', 'b'): 1, ('c', 'b', 'a'): 1, ('b', 'a', 'a'): 1}]
...
### Formula
- ***$$P(X_1=x_1, X_2=x_2, \ldots, X_t=x_t) = P(x_1) \cdot P(x_2 \mid x_1) \cdot P(x_3 \mid x_1, x_2) \cdots P(x_t \mid x_1, x_2, \ldots, x_{t-1})$$***

### Code analysis

- ***The calculate_probability is to compute the probability of a character that appears in a given situation. If the sequence is empty (where n = 0), the condition frequency will be the sum of all unigrams. Else, we need to use the conditional probability formula to calculate for each character given a sequence.***
