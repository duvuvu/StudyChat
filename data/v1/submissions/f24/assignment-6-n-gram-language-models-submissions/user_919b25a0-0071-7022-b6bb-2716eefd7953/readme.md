...
The `create_frequency_tables` function is a foundational step in building a character-level language model. By analyzing character sequences and their frequencies in a structured manner, this process allows further functionalities such as probability calculations and character predictions to be effectively performed. The use of frequency tables captures the essence of patterns in text, which is essential for many natural language processing tasks.
...
- ***Put the intuition of your code here***
The `calculate_probability` function allows a user to understand the likelihood of seeing a certain character follow a specific sequence based on historical data. It leverages frequency counts from n-grams effectively to provide meaningful probabilistic insights, which are crucial in many natural language processing tasks, such as character prediction, text generation, and other language modeling applications. This probabilistic framework is powerful for tasks requiring an understanding of text patterns and relationships.
...
### Calculation of \( P(X_1 = a, X_2 = a, X_3 = a) \)

To calculate the joint probability, we use the **chain rule**:
...
#### Step 2: Find \( P(X_2 = a \mid X_1 = a) \)
From **Probability Table 2**:
\[
P(X_2 = a \mid X_1 = a) = P(a \mid a) = \frac{5}{10}
\]

#### Step 3: Find \( P(X_3 = a \mid X_1 = a, X_2 = a) \)
From **Probability Table 3**:
\[
P(X_3 = a \mid X_1 = a, X_2 = a) = P(a \mid a, a) = \frac{1}{4}
\]
...
\[
P(X_1 = a, X_2 = a, X_3 = a) = \frac{11}{20} \cdot \frac{5}{10} \cdot \frac{1}{4}
\]
...
\[
P(X_1 = a, X_2 = a, X_3 = a) = \frac{11 \cdot 5 \cdot 1}{20 \cdot 10 \cdot 4}
\]

\[
P(X_1 = a, X_2 = a, X_3 = a) = \frac{55}{800}
\]
...
2. $P(X_1=a, X_2=a, X_3=b)$
   - *Show your work*
   ### Calculation of \( P(X_1 = a, X_2 = a, X_3 = b) \)
...
#### Step 3: Find \( P(X_3 = b \mid X_1 = a, X_2 = a) \)
From **Probability Table 3**:
\[
P(X_3 = b \mid X_1 = a, X_2 = a) = P(b \mid a, a) = \frac{2}{4}
\]
...
\[
P(X_1 = a, X_2 = a, X_3 = b) = \frac{11 \cdot 5 \cdot 2}{20 \cdot 10 \cdot 4}
\]

\[
P(X_1 = a, X_2 = a, X_3 = b) = \frac{110}{800}
\]
...
3. $P(X_1=a, X_2=a, X_3=c)$
   - *Show your work* 
### Calculation of \( P(X_1 = a, X_2 = a, X_3 = c) \)
...
#### Step 3: Find \( P(X_3 = c \mid X_1 = a, X_2 = a) \)
From **Probability Table 3**:
\[
P(X_3 = c \mid X_1 = a, X_2 = a) = P(c \mid a, a) = \frac{1}{4}
\]
...
\[
P(X_1 = a, X_2 = a, X_3 = c) = \frac{11 \cdot 5 \cdot 1}{20 \cdot 10 \cdot 4}
\]

\[
P(X_1 = a, X_2 = a, X_3 = c) = \frac{55}{800}
\]
...
- ***Put the intuition of your code here***
The `predict_next_char` function uses the knowledge captured in n-gram frequency tables to make educated guesses about which character is likely to follow a given sequence. By harnessing those historical frequency counts, it enables predictions that reflect the patterns found in language, thus providing a basis for intelligent text generation and completion. This predictive capability leverages statistical relationships learned from data, making it a powerful tool in various applications requiring natural language understanding and generation.
...
The Alice corpus runs much faster than War and Peace, even with a value of n=10. For Alice you can go pretty high for the value of n and the runtime is still just a few seconds.  Going up to around n=100 for Alice was pretty time consuming, like around a minute, although the idea of too high of a value is pretty arbitrary. 
