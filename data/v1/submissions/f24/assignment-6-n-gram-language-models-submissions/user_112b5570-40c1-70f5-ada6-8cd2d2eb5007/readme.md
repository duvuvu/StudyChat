...
I slowly iterated over the document as substrings with an initial length of 1 up to n. With each substring, I checked to see if it is in the frequency table, represented as a list of n dictionaries. If a substring of length x is present in the frequency table, we increase its count/frequency by incrementing the value associated with that key(substring). If not, then we initialize the key and give it a value of 1. We repeat that until we reach the end of the document.
...
$P(char \mid sequence) = \frac{P(sequence + char)}{P(sequence)}$

### Code analysis

- We find the frequency of the (sequence + char) tuple from our frequency table, and then divide this by the frequency of the (sequence) tuple to get the probability. If the denominator is zero, we return 0.
...
1. $P(X_1=a, X_2=a, X_3=a)$
   - *Show your work*
    ...
    $$
    P(X_1=a, X_2=a, X_3=a) = P(a \mid aa)\times P(aa)
    $$
    $$
    P(X_1=a, X_2=a, X_3=a) = P(a \mid aa)\times P(a \mid a) \times P(a)
    $$
    $$
    P(X_1=a, X_2=a, X_3=a) = \frac{1}{5} \times \frac{5}{11} \times \frac{11}{20}
    $$
    $$
...
$$
P(X_1=a, X_2=a, X_3=a) = P(b \mid aa)\times P(aa)
$$
$$
P(X_1=a, X_2=a, X_3=a) = P(b \mid aa)\times P(a \mid a) \times P(a)
$$
$$
P(X_1=a, X_2=a, X_3=a) = \frac{2}{5} \times \frac{5}{11} \times \frac{11}{20}
$$
$$
P(X_1=a, X_2=a, X_3=a) = \frac{1}{10}
$$

3. $P(X_1=a, X_2=a, X_3=c)$

$$
P(X_1=a, X_2=a, X_3=a) = P(c \mid aa)\times P(aa)
$$
$$
P(X_1=a, X_2=a, X_3=a) = P(c \mid aa)\times P(a \mid a) \times P(a)
$$
$$
P(X_1=a, X_2=a, X_3=a) = \frac{1}{5} \times \frac{5}{11} \times \frac{11}{20}
$$
...
I created a dictionary, where I will be storing the given conditional probabilities of all the possible next characters listed in the vocabulary. Once that's done, I iterate over the dictionary to see which probability is the highest, and that will allow us to predict the next character.
...
I tested the n-gram autocomplete functionality using several corpora, including War and Peace and Alice in Wonderland, and a bunch of small stories that I could paste into my code. For smaller corpora like the short stories, the model performed reasonably well for  n \leq 3 , but higher values of  n  resulted in sparse frequency tables, leading to many zero-probability predictions. Larger corpora like War and Peace produced better predictions for  n  values up to 4 or 5, as the dataset provided sufficient context to populate the tables effectively. However, as  n  increased beyond 5, the table calculations became computationally expensive, and the predictive performance plateaued due to diminishing returns in capturing longer dependencies. Overall, larger corpora with richer linguistic structures worked better for higher  n -gram models, while smaller corpora were more efficient but less effective for larger  n .
